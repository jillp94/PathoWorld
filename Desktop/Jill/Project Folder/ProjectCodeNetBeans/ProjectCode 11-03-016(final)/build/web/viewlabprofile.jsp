   ...
   .nav-pills>li>a{
    ...
    <body>
        ...
        <%
            ...
            Iterator ia = new model.database().viewlabProfile(labid).iterator();
            Iterator ia1 = new model.database().viewPatientFeedback(lname).iterator();
                ...
                <div class=" col-md-12 col-lg-12 jumbotron">
                    <div class="text-center">
                        ...
                        <div class="myimg">
                            ...
                            <h3><font color="#000" face="Times New Roman, Times, serif">Laboratory Admin: <%=s[11]%></font></h3>
        ...
        <div class="container">
            <div class="row"> 
                ...
                font-family:Times New Roman,Times, serif; padding: 10px 10px 10px 10px;"
                    >
                    <li class="active"><a data-toggle="pill" href="#about"></span>About Us</a></li>
